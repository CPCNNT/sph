      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="changeActive(spuSaleAttrValue.saleAttrValueName, spuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="amount" @change="changeAmount" />
                <a href="javascript:" class="plus" @click="increment">+</a>
                <a href="javascript:" class="mins" @click="decrement">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  export default {
    ...
    methods: {
      changeActive(saleAttrValueName, spuSaleAttrValueList) {
      ...
      async addToCart() {
        try {
          await this.$store.dispatch('addOrUpdateCart', {skuId: this.$route.params.skuid, skuNum: this.amount})
          sessionStorage.setItem('SKUINFO', JSON.stringify(this.skuInfo))
          this.$router.push({name: 'addcartsuccess', query: {skuNum: this.amount}})
        } catch (error) {
          alert(error.message)
        }
      }
